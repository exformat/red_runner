...
import com.exformatgames.defender.game.screens.GameScreen;
...
public class PlayerSystem extends IteratingSystem {
	...
	protected void processEntity(Entity entity, float dt) {
		...
		GameScreen.SCORE = playerComponent.score;
		GameScreen.GEMS = playerComponent.gems;
		GameScreen.PLAYER_STATE = playerComponent.playerState;
	}
}
